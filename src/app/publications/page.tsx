...
export default async function PublicationsPage({
  ...
  const res = await fetch(
    `${process.env.API_URL}/topic/publications?page=${searchParams['page'] || 1}`
  );
  ...
  return (
    <>
      ...
      <PageIntro
        ...
        subtitle='Dive into the Gendermobile publications to discover inspiring stories, and actionable tips on gender and sexual based violence.'
      />
